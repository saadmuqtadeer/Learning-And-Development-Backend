...
namespace ApplicationService.Migrations
{
    ...
    [Migration("20240909114633_updateTrainingRequest")]
    partial class updateTrainingRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationService.Model.TrainingRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApplicationService.Model.TrainingRequest", b =>
                {
                    b.HasOne("AuthAPI.Models.Register", "Register")
                        .WithMany()
